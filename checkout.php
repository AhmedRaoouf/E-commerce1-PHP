              ...
              <div class="card border-0 rounded-0 p-lg-4 bg-light">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    ?>
                    <li class="d-flex align-items-center justify-content-between"><strong class="small font-weight-bold"><?=$product['Name'] . "  $q" ?></strong><span class="text-muted small">$<?=$product['price']?></span></li>
