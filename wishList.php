...
<html>
  ...
  <body>
    <div class="page-holder">
      ...
      <div class="container">
        ...
        <section class="py-5">
          <h2 class="h5 text-uppercase mb-4">Favorite Items</h2>
          <div class="row">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <?php
                      ...
                      $selectUser = "SELECT * FROM wishList WHERE user_id = '$userId' ";
                    ...
                    <tr class="<?=$product['id']?>">
                      <td class="pl-0 border-0" scope="row">
                        <div class="media align-items-center mx-5"><a class="reset-anchor d-block animsition-link" href="detail.php?cat_id=<?=$product['cat_id']?>&id=<?=$product['id']?>">
                          <img src="<?php
                          ...
                          <td class="align-middle border-0"><a class="reset-anchor del-pro" href="" data-id="<?=$product['id']?>">
  ...
  <script>
    ...
    $('.del-pro').click(function (e) { 
        e.preventDefault();
        let id = $(this).data('id'),
            url = "admin/functions/userCart.php",
            wish = "wishList";
