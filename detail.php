<?php
  ...
  if (isset($_GET['id'])) {
    $id =$_GET['id'];
    $select = $select = "SELECT * FROM products WHERE id = '$id' ";
                ...
                <div class="col-lg-6">
                  ...
                  <div class="p-5 my-md-4">
                    ...
                    <div class="row align-items-stretch mb-4">
                      ...
                      <div class="col-sm-5 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="admin/functions/userCart.php?id=<?= $product['id']?>">Add to cart</a></div>
      ...
      <section class="py-5">
        <div class="container">
          <div class="row mb-5">
            <div class="col-lg-6">
              ...
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                  ...
                  <?php
                        $allImg = explode(',',$product['img']);
                        foreach ($allImg as $img){
  
                  ?>

                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
                      <img class="w-100" src="admin/new_images/<?=$img?>" alt="...">
                    </div>
                    <?php }?>  
                  </div>
                ...
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1">
                    ...
                    ?>
                    <a class="d-block" href="admin/new_images/<?=$img?>" data-lightbox="product" title="<?=$product['Name']?>">
                    <img class="img-fluid" src="admin/new_images/<?=$img?>" alt="..."></a>
                    <?php }?>  
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              ...
              <div class="row align-items-stretch mb-4">
                ...
                <div class="col-sm-3 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="admin/functions/userCart.php?id=<?= $product['id']?>">Add to cart</a></div>
              </div><a class="btn btn-link text-dark p-0 mb-4" href="admin/functions/userWishList.php?id=<?= $product['id']?>"><i class="far fa-heart mr-2"></i>Add to wish list</a><br>
              <ul class="list-unstyled small d-inline-block">
                ...
                <?php
                    ...
                    $cat = "SELECT * FROM category WHERE id = '$catId' ";
                    $query = $conn -> query($cat) ->fetch_assoc();
                    echo $query['Name'] ;
                  ?>
                </a></li>
          ...
          <div class="row">
            <!-- PRODUCT-->
            <?php
            $relatedPro = "SELECT * FROM products WHERE cat_id = '$catId' ";
            $query = $conn ->query($relatedPro);
            foreach ($query as $pro){
             $imgs = explode(',',$pro['img'])
            ?>
            <div class="col-lg-3 col-sm-6">
              <div class="product text-center skel-loader">
                <div class="d-block mb-3 position-relative"><a class="d-block" href="detail.php?cat_id=<?=$pro['cat_id']?>&id=<?=$pro['id']?>">
                  <img class="img-fluid w-100" src="admin/new_images/<?=$imgs[0]?>" alt="..."></a>
                  <div class="product-overlay">
                    <ul class="mb-0 list-inline">
                      ...
                      <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="admin/functions/userCart.php?id=<?= $pro['id']?>">Add to cart</a></li>
